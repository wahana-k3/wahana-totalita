import allTrainings from '@/data/trainings/all.json';
import kemnakerTrainings from '@/data/trainings/kemnaker.json';
import bnspTrainings from '@/data/trainings/bnsp.json';
import inhouseTrainings from '@/data/trainings/inhouse.json';
import softskillsTrainings from '@/data/trainings/softskills.json';
